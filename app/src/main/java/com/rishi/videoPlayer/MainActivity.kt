...
import com.rishi.videoPlayer.databinding.ActivityMainBinding
import com.rishi.videoPlayer.databinding.ThemeViewBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.bottomNav.setOnItemSelectedListener {
            when (it.itemId) {
                ...
                R.id.trandingView -> setFragment(WebViewFragment())
            }
